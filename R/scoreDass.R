...
#' directory does not have a masterCOURSENAMEDass.csv file in it, it will create that file
...
#' participant ID column is labeled 'ID' and that the DASS columns begin with 'DASS_.' It assumes
